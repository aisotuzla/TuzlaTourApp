...
const LOCATIONS_RAW: Location[] = [
  ...
  },
  {
    ...
    coordinates: [44.5399376, 18.6825529],
    category: 'culture',
    qrCode: 'QRfrida',
    discount: 'Art Reward - NFT',
    address: 'Prof. dr. Ibre Pašića, 75000 Tuzla, Bosnia and Herzegovina',
  },
  {
    id: 'neolit',
    name: {
      en: 'Neolithic Settlement',
      bs: 'Sojeničko naselje',
    ...
    coordinates: [44.5385309, 18.6819089],
    category: 'culture',
    qrCode: 'QRneolit',
    discount: 'Discovery Reward - NFT',
    address: 'Kulina bana, 75000 Tuzla, Bosnia and Herzegovina',
  },
  {
...
const TRANSLATIONS_RAW: Record<Language, TranslationSet> = {
  ...
  bs: {
    ...
    privacyDisclaimerText: 'Ova aplikacija funkcionira kao nekustodijalni, samosuvereni interfejs. Pružamo alate za interakciju s informacijama i blockchain uslugama, ali vi zadržavate apsoluto vlasništvo i kontrolu nad svojim digitalnim sredstvima i identitetom.',
    privacyKeyPointsTitle: 'Ključne tačke privatnosti i sigurnosti podataka',
    zeroCustodyTitle: 'Nulta kustodija nad imovinom:',
  ...
  tr: {
    ...
    privacyByDesignText: 'Bosna Hersek Kişisel Verilerin Korunması Kanunu (BiH Resmi Gazetesi, No. 12/25, GDPR ile uyumlu) uyarınca, bu uygulama sıfır kişisel tanımlayıcı bilgi (PII) toplayacak şekilde oluşturulmuştur.',
