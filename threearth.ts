...
const earthMaterial = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load(`https://z2586300277.github.io/3d-file-server/` + 'threeExamples/shader/earth1.jpg') })
 ...
 * refer: https://juejin.cn/post/7378535517950525466 
 */
